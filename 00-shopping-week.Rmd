...
If you do not have the proper packages installed for a tutorial, a pop-up message will show asking you to install the specified packages. For the Visualization tutorial, you may not have the package ***viridis***. R will ask you whether to proceed the download; click "yes".

`r include_graphics("00-shopping-week/images/viridis_install.PNG")`
...
* If you accidentally clicked "Start Tutorial", you can navigate to the Jobs tab in the bottom left quadrant of RStudio. Clicking the back arrow, and then press the red stop sign icon.
