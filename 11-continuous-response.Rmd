...
fit_resamples(object = stan_model,
              preprocessor = recipe(demo_form, ch11_training),
              resamples = ch11_folds)
```   
...
Looking at the results, it seems like `pres_appr` is a good predictor variable to incorporate, as the rmse for `race_form` is much lower than that of the Demographic model, which does not include `pres_appr`. This makes sense, as how you lean ideologically is very likely correlated with how you feel about the President.
