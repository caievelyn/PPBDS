...
Which will take in a value `x` and return a value `x + 1`. We will dive into functions more in depth soon, but next we will discuss of list-columns and `map_*` functions. 
